...
val seed = Color(0xFFFC8300)
val SecondSurfaceLight = Color(0x6EFFFBFF)
val SecondSurfaceDark = Color(0x6E201A17)
val SecondSurface = if (Theme.isDarkMode.value) SecondSurfaceDark else SecondSurfaceLight

val SecondSurfaceVariantLight = Color(0xFFF3DFD2)
val SecondSurfaceVariantDark = Color(0xFF52443B)
val SecondSurfaceVariant = if (Theme.isDarkMode.value) SecondSurfaceVariantDark else SecondSurfaceVariantLight
